...
public class MasterCardProcessingService implements ProcessingCenterStrategy {
    ...
    public SimpleResponse transfer(TransferrRequest transferrRequest) {
        ...
        if (card.getPayment().equals(foundCard.getPayment())) {
            ...
            // С комиссией 2%
            if (card.getBalance() >= transferrRequest.getSumma() * 1.01) {
                double commission = transferrRequest.getSumma() * 0.01;
